...
%load in new network here...
google = googlenet;
analyzeNetwork(google);

inputSize = google.Layers(1).InputSize;
networkArchitecture = layerGraph(google);

featureExtractor = google.Layers(142);
classiferOutput = google.Layers(144);
...
retrainedGoogle = trainNetwork(resizedTrainingData, networkArchitecture, options);